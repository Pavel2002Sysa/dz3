...
conn = psycopg2.connect(dbname="iu5", user="postgres", password="iu5-magisters", host="localhost", port=5432)
...
insert_req = ""
for id in range(1, 500 + 1): # вместо 1_000_000 надо вставить число конфигураций, которые будут добавлены в БД 
